...
L.CONTEXT_MENU_STOP_TRACKING = "Прекратить отслеживание"
L.CONTEXT_MENU_STOP_WATCHING = "Прекратить смотреть"
L.CONTEXT_MENU_SUPERTRACK = "Супертрек"
L.DELVE = "Вылазка"
L.DUNGEON = "Подземелье"
L.HELPER_WINDOW_ACHIEVEMENT = "достижение"
L.HELPER_WINDOW_COPY_SHORTCUT = "Ctrl + C, чтобы скопировать"
