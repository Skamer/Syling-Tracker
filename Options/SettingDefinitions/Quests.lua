...
class "SettingDefinitions.Quests" (function(_ENV)
  ...
  function BuildQuestTab(self)
    ...
    legendaryQuestBackgroundColorPicker:SetLabel(CreateAtlasMarkup("QuestLegendary", 18, 18) .. " Legendary Quest")
    ...
    legendaryQuestBorderColorPicker:SetLabel(CreateAtlasMarkup("QuestLegendary", 18, 18) .. " Legendary Quest")
    ...
    headertabControl:AddTabPage({
      ...
      onAcquire = function()  
        ...
        legendaryQuestTextColorPicker:SetLabel(CreateAtlasMarkup("QuestLegendary", 18, 18) .. " Legendary Quest")
